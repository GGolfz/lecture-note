          ...
          Consumer<ApplicationState>(
            builder: (context, appState, _) {
              if (appState.attendees >= 2) {
                return Paragraph('${appState.attendees} people going');
              } else if (appState.attendees == 1) {
                return Paragraph('1 person going');
              } else {
                return Paragraph('No one going');
              }
            },
          )
        ],
            ...
            children: [
              ElevatedButton(
                style: ElevatedButton.styleFrom(
                    elevation: 0, textStyle: TextStyle(color: Colors.white)),
                child: Text('YES'),
